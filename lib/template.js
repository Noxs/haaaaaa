...
const TemplateError = require('./tree/templateError.js');
const BadParameterError = require('./tree/badParameterError.js');
...
class Template {
    ...
    replaceTemplate(beginning, ending, template) {
        if (template.constructor !== Template) {
            throw new BadParameterError("Third parameter of template replaceTemplate() method must be a Template object", template);
        }
