...
class ForNode extends Node {
    ...
    getContextForChildren() {
        ...
        this._copiedContext[this._forContextVariableName] = this._getForContextVariable();
        this._copiedContext.modify(this._forContextVariableName);
        this._copiedContext[this._value] = this._copiedContext[this._forContextVariableName][this._currentIteration];
