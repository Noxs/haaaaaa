...
class VariableNode extends Node {
    ...
    extractFilters() {
        ...
        if (filtersSplitted.length === 2) {
            this._nodeFilter.extract(filtersSplitted[1].trim());
        }
        return this;
    }
    ...
    preExecute() {
        this._fetchContext();
        this._fetchFilters();
        this._nodeFilter.setFilters(this.getFilters());
    ...
    postExecute() {
        ...
        if (this.hasFilters() === true) {
            value = this._nodeFilter.execute(value, this.context);
        }
    ...
    hasFilters() {
        return this._nodeFilter.hasFilters();
    }
}
