class Translator {
    ...
    set translations(translations){
        if(typeof(translations) !== 'object'){
            throw new Error('First parameter of translations setter in Translator object must be an object.');
        }
    ...
    set language(language){
        ...
        if(typeof(language) !== 'string'){
            throw new Error('First parameter of language setter in Translator object must be a string.');
        }
    ...
    set fallbackLanguage (language){
        if(typeof(language) !== 'string'){
            throw new Error('First parameter of fallbackLanguage setter in Translator object must be a string.');
        }
