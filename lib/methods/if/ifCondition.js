...
class IfCondition {
    ...
    _evaluateString(string, context) {
        if (typeof (string) !== 'string') {
            throw new Error('Fisrt parameter of ifCondition._evalutateString() must be a string.');
        }
        if (!context || context.constructor !== Context) {
            throw new Error('Second parameter of ifCondition._evalutateString() must be a Context object.');
        }
        let result = null;
        try {
