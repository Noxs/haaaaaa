    ...
    _parse() {
        ...
        for (let i = 0, length = this._rawFilter.length; i < length; i++) {
            if (this._rawFilter[i] === flags.CURLY_BRACKET_OPEN && singleQuote === false && doubleQuote === false) {
                ...
                squareBracket--;
            } else if (this._rawFilter[i] === flags.BRACKET_OPEN && singleQuote === false && doubleQuote === false) {
                bracket++;
            } else if (this._rawFilter[i] === flags.BRACKET_CLOSE && singleQuote === false && doubleQuote === false) {
                bracket--;
            }
            ...
            } else if ((this._rawFilter[i] === flags.COLON || this._rawFilter[i] === flags.COMMA) && singleQuote === false && doubleQuote === false && squareBracket === 0 && curlyBracket === 0 && bracket === 0) {
