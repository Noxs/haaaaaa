...
describe('StringFilterNode', function () {
    it('StringFilterNode constructor', function () {
        const testFunc = function () {
            const stringFilterNode = new StringFilterNode("  This is a string", 1);
        };
        expect(testFunc).to.not.throw();
    });

    it('StringFilterNode _parse(): success', function () {
        const stringFilterNode1 = new StringFilterNode("  'this is a string1'   ", 1);
        assert.equal(stringFilterNode1._value, "this is a string1");

        const stringFilterNode2 = new StringFilterNode(' "this is a string2"  ', 1);
        assert.equal(stringFilterNode2._value, "this is a string2");

        const stringFilterNode3 = new StringFilterNode(' "this is a string3 "  ', 1);
    ...
    it('StringFilterNode _parse() : failure', function () {
        ...
        const testFunc2 = function () {
            const stringFilterNode2 = new StringFilterNode('  "this is a string1  ', 1);
        };
